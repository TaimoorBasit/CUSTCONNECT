                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: Colors.white.withOpacity(0.1), width: 6),
                          ),
                          child: const Center(
                              child: Text('92%',
                                  style: TextStyle(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                  'Midterm schedules are now available for Spring 2026.',
                                  style: TextStyle(
                                      fontSize: 14,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                            color: theme.scaffoldBackgroundColor, width: 5),
                      ),
