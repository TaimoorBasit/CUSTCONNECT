      ...
      <div className="bg-white border-b border-gray-200 px-6 py-6 md:px-10 mb-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#1a2744] tracking-tight">Vendor Registry</h1>
              <p className="text-sm text-gray-400 mt-0.5">Manage vendor partners and service providers</p>
            </div>
          </div>
