  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="text-gray-500 font-medium animate-pulse">Computing platform metrics...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-12 px-4 sm:px-0">
      ...
      <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#1a1b3b] to-indigo-900 p-8 md:p-12 shadow-2xl transition-all duration-700">
        <div className="absolute top-0 right-0 -m-12 w-96 h-96 bg-indigo-500/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-0 left-0 -m-8 w-64 h-64 bg-purple-500/10 rounded-full blur-[80px]" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-indigo-100/60 leading-relaxed font-medium">
              Real-time visualization of platform growth, user behavioral patterns, and service performance metrics.
            </p>
          </div>
          <div className="hidden md:block">
            <div className="px-6 py-3 bg-white/5 border border-white/10 rounded-2xl text-white/40 text-xs font-black uppercase tracking-widest">
