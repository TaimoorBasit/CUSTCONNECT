        ...
        <div className="relative z-10 flex h-full flex-col justify-center p-12 text-white">
          <div className="mb-14">
            <Image
              ...
              width={800}
              height={250}
              className="h-56 w-auto object-contain brightness-110 drop-shadow-2xl"
              priority
            />
          </div>
          ...
          <div>
            <div className="mb-12 text-center">
              <Image
                ...
                width={600}
                height={200}
                className="h-48 w-auto object-contain mx-auto mb-8"
                priority
              />
